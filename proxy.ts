...
function detectLocaleFromLanguage(acceptLanguage: string): string {
...
export default function proxy(request: NextRequest) {
  ...
  // /assessment (no locale prefix) → redirect based on Accept-Language header
  if (pathname === '/assessment') {
    const locale = detectLocaleFromLanguage(
